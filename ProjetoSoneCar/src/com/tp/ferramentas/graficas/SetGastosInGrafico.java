...
public class SetGastosInGrafico {
    ...
    public void gerarGraficoGastos(int tipoDeGastosId, int mesDesejado) throws Exception {
        SepararGastosPorDate ferramenta = new SepararGastosPorDate();
        Stack<Gastos> pilhaGastos = ferramenta.organizarGastosPorData(tipoDeGastosId, mesDesejado);
